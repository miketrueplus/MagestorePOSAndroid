...
public interface ChildListService<TParent extends Model, TModel extends Model> extends Service {
    ...
    boolean update(TParent parent, TModel... models) throws IOException, InstantiationException, ParseException, IllegalAccessException;
    boolean insert(TParent parent, TModel... models) throws IOException, InstantiationException, ParseException, IllegalAccessException;
    boolean delete(TParent parent, TModel... models) throws IOException, InstantiationException, ParseException, IllegalAccessException;
}