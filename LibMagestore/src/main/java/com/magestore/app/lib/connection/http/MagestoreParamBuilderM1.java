...
public class MagestoreParamBuilderM1 implements ParamBuilder {
    // các ký tự
    ...
    // phân trang
    private final static String SEARCH_CRITERIA_PAGESIZE = "limit=${magestore_pageSize}";
    private final static String SEARCH_CRITERIA_PAGE = "page=${magestore_currentPage}";
    ...
    public MagestoreParamBuilderM1(Statement statement, Map mapKeyValue) {
