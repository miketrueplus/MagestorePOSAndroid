...
import com.magestore.app.lib.adapterview.adapter2pos.Adapter2Entity;
...
public class CustomerAddressPanel extends FrameLayout {
    ...
    public void setAddress(Address address) {
        ...
        Adapter2Entity adapter2Entity = new Adapter2Entity();
        adapter2Entity.toView(this, mAddress);
    ...
    public Address getAddress() {
        Adapter2Entity adapter2Entity = new Adapter2Entity();
        adapter2Entity.fromView(this, mAddress);
