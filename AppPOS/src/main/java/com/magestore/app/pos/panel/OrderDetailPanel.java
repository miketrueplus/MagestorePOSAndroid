...
//                }
    ...
    private void actionPrint() {
        ...
        dialogPrint.setContentView(R.layout.star_print_layout);
...
//        PrintUtil.doPrint(getContext(), mOrder, dialogWebView);
        ...
        if (!StringUtil.isNullOrEmpty(mOrder.getShippingDescription())) {
            tv_shipping.setVisibility(VISIBLE);
        ...
        tv_price_subtotal.setText(ConfigUtil.convertToPrice(mOrder.getBaseSubtotalInclTax()) + "");
        ...
        tv_price_shipping.setText(ConfigUtil.convertToPrice(mOrder.getBaseShippingInclTax()) + "");
        ...
        tv_price_discount.setText(ConfigUtil.convertToPrice(mOrder.getBaseDiscountAmount()) + "");
        ...
        tv_price_gift_voucher_discount.setText(ConfigUtil.convertToPrice(mOrder.getBaseGiftVoucherDiscount()) + "");
        ...
        tv_price_reward_point_discount.setText(ConfigUtil.convertToPrice(mOrder.getRewardPointsBaseDiscount()) + "");
        ...
        bt_print.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                StarPrintUtitl.showSearchPrint(getContext(), ((OrderHistoryListController) mController).getMagestoreContext().getActivity(), mOrder, bitmap);
